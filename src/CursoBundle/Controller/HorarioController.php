...
use CursoBundle\Form\Type\HorarioType;
...
class HorarioController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $horarios = $em->getRepository('CursoBundle:Horario')->findAll();
    ...
    {
        $horario = new Horario();
        $form = $this->createForm('CursoBundle\Form\Type\HorarioType', $horario);
    ...
    {
        $deleteForm = $this->createDeleteForm($horario);
        $editForm = $this->createForm('CursoBundle\Form\Type\HorarioType', $horario);
